...
//
// One connection per tab is the invariant. That's why the provider mounts above
// <Routes> in app.tsx (navigation must not churn the connection) and why
// useNotifications no longer opens a stream of its own.
